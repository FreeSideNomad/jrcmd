...
class JdbcPgmqClientTest {
    ...
    class GetFromArchiveTests {
        ...
        void shouldReturnMessageWhenFound() {
            PgmqMessage msg = new PgmqMessage(123L, 1, Instant.now(), null, Map.of("command_id", "commandbus-123"));
            ...
            Optional<PgmqMessage> result = client.getFromArchive("test_queue", "commandbus-123");
        ...
        void shouldReturnEmptyWhenNotFound() {
            ...
            Optional<PgmqMessage> result = client.getFromArchive("test_queue", "commandbus-999");
