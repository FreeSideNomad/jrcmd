...
import com.ivamare.commandbus.exception.CommandNotFoundException;
import com.ivamare.commandbus.exception.InvalidOperationException;
...
public interface TroubleshootingQueue {
     ...
     * @return Domain name
     * @throws CommandNotFoundException if not found
     */
     ...
     * @throws InvalidOperationException if not in TSQ
     */
